...
//           className={`absolute  bottom-[95px] md:bottom-[50px] border-2 border-dotted border-white transition-all duration-500 ease-out bg-gray-800 rounded-lg text-center p-4 z-10 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-full'
//             }`}
//           style={{ width: 'calc(100% - 40px)', maxWidth: '400px' }}
//         >
//           <p style={{fontFamily:'Gilroy'}}>{content}</p> {/* Dynamically display the content */}
//         </div>
...
//           style={{ width: 'calc(100% - 40px)', maxWidth: '400px', opacity: isVisible ? 1 : 0 }} // Set full opacity for the slider when visible
//         >
//           {/* <p style={{ fontFamily: 'Gilroy' }}>{content}</p>  */}
