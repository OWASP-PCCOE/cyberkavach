        ...
        >
            ...
            <style>
                ...
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>08 October</p>
                ...
                {/* Timeline Event 2 */}
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>09 October</p>
                ...
                {/* Timeline Event 3 */}
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>14 October</p>
                ...
                {/* Timeline Event 4 */}
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>16 October</p>
                ...
                {/* Timeline Event 4 */}
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>18 October</p>
                ...
                {/* Timeline Event 4 */}
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>21 October</p>
                ...
                {/* Timeline Event 4 */}
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>22 October</p>
                ...
                {/* Timeline Event 4 */}
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>23 October</p>
                ...
                {/* Timeline Event 4 */}
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>24 October</p>
                ...
                <div className='w-[4px]  bg-green-300 h-[110px] ml-auto mr-auto neon-lime'></div>
                <div className=' shadow-2xl shadow-blue-500 bg-gradient-to-r from-slate-900 from-10% via-slate-600 via-30% to-slate-900 to-90% h-auto md:w-[500px] w-[350px] rounded-xl text-white border-2 flex flex-col items-center border-white'>
                    <p className='bg-white md:text-3xl text-xl text-black border-2 mt-4 p-4 rounded-2xl neon-gray' style={{ fontFamily: 'NeueMachina' }}>25 October</p>
